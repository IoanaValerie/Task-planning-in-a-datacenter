...
public class Main {
    ...
    private static int runTest(Test test) {
        ...
        File[] dir = new File("/home/asus/Documents/APD/teme/tema2/checker/in" + File.separator + test.inFolder).listFiles();
        if (dir != null) {
            for (File input : dir) {
        ...
        try {
            String output = new Scanner(new File("/home/asus/Documents/APD/teme/tema2/checker/in" + File.separator + test.inFolder + File.separator + "out")).useDelimiter("\\Z").next();
